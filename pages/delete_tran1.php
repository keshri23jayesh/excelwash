<!-- Delete -->
<div class="modal fade" id="delete_tra<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="connections_pro/delete_tran1.php?id=<?php echo $row['id']; ?>">
